...
随着综合工具的不断智能化，使用 RTL 级语言描述硬件电路越来越方便。特别是在可编程逻辑器件（PLD，主要指 FPGA 和 CPLD）设计领域，最重要的代码设计层次就是 RTL 级。
...
这些关键字的语法在 [Part 2——Verilog 语言基础][]和 [Part 3——描述方式和设计层次][] 中都有详细介绍，请参考这部分内容。
