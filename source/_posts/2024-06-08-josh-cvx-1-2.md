...
$$\begin{equation}\label{polyhedron-1}
  \mathcal{P} = \left\{ x\mid a_j^\TT x \leqslant b_j,\ j = 1,\cdots,m,\ c_j^\TT x = d_j,\ j = 1,\cdots,p\right\}
\end{equation}$$
...
![图 11. 多面体 $\mathcal{P}$（阴影所示）是外法向量为 $a_1,\cdots,a_5$ 的五个半空间的交集。](../images/post/2024-06-08-josh-cvx-1-2/2024-06-08-josh-cvx-1-2-110-Polyhydron.png){width=400px}

&emsp;&emsp;可以方便地使用紧凑表达式

$$\begin{equation}\label{polyhedron-2}
  \mathcal{P} = \left\{ x\mid Ax \preceq b,\ Cx = d \right\}
\end{equation}$$
